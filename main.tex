...
\section{ABSTRACT}
We are looking to construct a fully functional Yahtzee score-keeping device that allows multiple players to play the game with only the arduino hardware and a USB capable computer according to the full set of official Yahtzee rules. The program we construct will be able to take user-input decisions, generate dice rolls from those decisions, and return those rolls and a score to the user with an explanation of how their score was generated.
